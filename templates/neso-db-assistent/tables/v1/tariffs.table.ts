...
export const TTemplatesNesoDbAssistentTTemplatesNesoDbAssistentNesoAssistentV1TariffsA3xC1W = Heap.Table(
  't_templates_neso-db-assistent_t_templates_neso-db-assistent_neso_assistent_v1_tariffs_a3x_C1W',
  {
    tid: Heap.Optional(
...
export default TTemplatesNesoDbAssistentTTemplatesNesoDbAssistentNesoAssistentV1TariffsA3xC1W

export type TTemplatesNesoDbAssistentTTemplatesNesoDbAssistentNesoAssistentV1TariffsA3xC1WRow =
  typeof TTemplatesNesoDbAssistentTTemplatesNesoDbAssistentNesoAssistentV1TariffsA3xC1W.T
export type TTemplatesNesoDbAssistentTTemplatesNesoDbAssistentNesoAssistentV1TariffsA3xC1WRowJson =
  typeof TTemplatesNesoDbAssistentTTemplatesNesoDbAssistentNesoAssistentV1TariffsA3xC1W.JsonT
