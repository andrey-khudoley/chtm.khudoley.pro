...
declare type DomainMailingSettings = {
  name: string
  isEnabled: boolean
  isVerified: boolean
...
declare type MailerType = 'aws' | 'unknown'
declare type AWSDkimStatus = 'PENDING' | 'SUCCESS' | 'FAILED' | 'TEMPORARY_FAILURE' | 'NOT_STARTED'
declare type DkimStatus = AWSDkimStatus
...
export interface UgcDomainMailingSettings {
  isEnabled: DomainMailingSettings['isEnabled']
  name: DomainMailingSettings['name']
  isVerified: DomainMailingSettings['isVerified']
  tokens: DomainMailingSettings['tokens']
  dkimStatus: DomainMailingSettings['dkimStatus']
  mailerType: DomainMailingSettings['mailerType']
}
