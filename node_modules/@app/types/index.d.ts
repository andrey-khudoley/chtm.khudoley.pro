...
interface AuthProviderButtonInfo {
  ...
  style: BlockStyle<BackgroundGradientStyle & BorderStyle & OpacityStyle & ShadowStyle & SimpleBgColorStyle>
}
...
interface InternalRouteConstructorsWithBody<B extends BS> {
  ...
  job(path: string, handler: JobHandlerFn<VTR<B>, unknown | void>): JobRouteRef<VTC<B>>
