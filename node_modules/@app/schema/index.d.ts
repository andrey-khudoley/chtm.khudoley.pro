...
declare abstract class ChatiumError extends Error implements SerializableError {
...
declare class ValidationError extends ChatiumError {
  ...
  static deserialize(data: SerializableErrorData): ValidationError
  serialize(): Record<string, unknown>
...
interface SerializableErrorData {
  [key: string]: unknown
  n: string
  m: string
}
...
export interface ZEnum<ES extends tb.TEnumKey[]> extends ZType<hs.HsEnum<ES>>, ZEnumCommon<ES> {}
...
export interface ZNumber extends ZType<hs.HsNumber>, ZNumberCommon {
...
export interface ZString<S extends string = string> extends ZType<hs.HsString<S>>, ZStringCommon {}
...
export interface ZFuntionRouteRef<B, R> extends ZType<hs.HsFunctionRouteRef<B, R>>, ZFunctionRouteRefCommon {
...
export interface ZJobRouteRef<B> extends ZType<hs.HsJobRouteRef<B>>, ZJobRouteRefCommon {
  readonly items: readonly [ZNumber, ZString, ZString]
}
...
export interface ZLiteral<T extends tb.TValue> extends ZType<hs.HsLiteral<T>>, ZLiteralCommon<T> {}
...
export interface ZMoney extends ZType<hs.HsMoney>, ZMoneyCommon {
...
export interface ZObject<HSP extends hs.HsProperties> extends ZType<hs.HsObject<HSP>>, ZObjectCommon {
...
export interface ZRecord<KHS extends hs.HsRecordKey, VHS extends hs.HeapSchema>
...
export interface ZStorageFile extends ZType<hs.HsFile>, ZStorageFileCommon {}
...
export interface ZTuple<IHS extends hs.HeapSchema[]> extends ZType<hs.HsTuple<IHS>>, ZTupleCommon {
...
export interface ZUndefined extends ZType<hs.HsUndefined>, ZUndefinedCommon {}
declare type ZUndefinedOpts = hs.HsCommonOptions
export declare type ZUnknown = ZType<hs.HsUnknown>
