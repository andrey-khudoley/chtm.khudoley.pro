...
import {
  UgcAppMetricServiceEventData,
  UgcAppMetricServiceModel,
  UgcRouteType,
} from 'services/ugc-runner/runtime/runtimeTypes'
import { UgcSmartUser } from 'services/ugc-runner/runtime/user/UgcSmartUser'
import { AnyObject, JSONInputObject, JSONInputValue, PublicFieldsOfClass } from 'utils/types'
...
export declare type MetricEventJson = JSONInputObject &
...
export interface MetricEventData {
  ...
  action_param5_float?: number | undefined
  action_param6_float?: number | undefined
  action_param7_float?: number | undefined
  action_param8_float?: number | undefined
...
export declare function prepareMetricEvent(ctx: RichUgcCtx, rewrite?: UgcAppMetricEventData): Promise<MetricEventData>
export declare function prepareAppHostMetricEvent(
  ctx: RichUgcCtx,
  data?: UgcAppMetricEventData,
): Promise<MetricEventData>
export declare function writeMetricEvent(ctx: RichUgcCtx, data?: UgcAppMetricEventData): Promise<MetricEventData>
export declare function writeAppHostMetricEvent(ctx: RichUgcCtx, data?: UgcAppMetricEventData): Promise<MetricEventData>
/**
 * Subscribe to metric events ('metric-event' hook) for the given list of urlPaths.
 * The subscribed events may be handled by `app.plugin(account)Hook('metric-event', ...)`.
 * If `groupKey` is provided, then the given subscriptions are treated as a whole group
 *  and the existing subscriptions which are absent in the given list are removed.
 */
export declare function subscribeToMetricEvents<P extends JSONInputValue = JSONInputValue>(
  ctx: RichUgcCtx,
  subscriptions: string[] | Record<string, P>,
  /**
   * Optional subscribtions group.
   * It's possible to subscribe to the same urlPath with different params in different groups.
   */
  groupKey?: string | null,
): Promise<void>
export declare function unsubscribeFromMetricEventsGroup(ctx: RichUgcCtx, groupKey: string): Promise<void>
export declare function unsubscribeFromMetricEvents(ctx: RichUgcCtx, urlPaths: string[] | string): Promise<void>
/**
 * @deprecated use prepareMetricEvent instead
 */
export declare function prepareAccessLog(ctx: RichUgcCtx, rewrite?: UgcAppMetricEventData): Promise<MetricEventData>
/**
 * @deprecated use prepareAppHostMetricEvent instead
 */
export declare function prepareAppHostAccessLog(ctx: RichUgcCtx, data?: UgcAppMetricEventData): Promise<MetricEventData>
/**
 * @deprecated use writeMetricEvent instead
 */
export declare function writeAccessLog(ctx: RichUgcCtx, data?: UgcAppMetricEventData): Promise<MetricEventData>
/**
 * @deprecated use writeAppHostMetricEvent instead
 */
export declare function writeAppHostAccessLog(ctx: RichUgcCtx, data?: UgcAppMetricEventData): Promise<MetricEventData>
/**
 * @deprecated noop, use writeAccessLog instead
 */
export declare function writeEventLog(_ctx: RichUgcCtx, _model: UgcAppMetricServiceModel, _data?: any): Promise<void>
/**
 * @deprecated noop, use writeAppHostAccessLog instead
 */
export declare function writeAppHostEventLog(
  _ctx: RichUgcCtx,
  _model: UgcAppMetricServiceModel,
  _data?: any,
): Promise<void>
declare type UgcAppMetricEventData = UgcAppMetricServiceEventData & {
  user?: UgcAppMetricServiceEventData['user'] | UgcSmartUser
}

export { deserializeEvent as deserializeMetricEventRecord }
