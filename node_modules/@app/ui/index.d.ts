import { AttachMediaAction, ChatiumActions, ChatiumScreen } from 'lib/chatium-json'
...
interface ChatiumRc {
  ...
  signInPath?: string
  /** Caption for the sign-in consent (e.g. personal data agreement) checkbox */
  signInConsent?: string
...
export declare function attachMedia(params: AttachMediaParams): AttachMediaAction
declare type AttachMediaParams = Omit<AttachMediaAction, 'type' | 'filePutUrl' | 'getPutUrl'> &
  (
    | Pick<AttachMediaAction, 'filePutUrl' | 'getPutUrl'>
    | ({
        filePutUrl?: undefined
        getPutUrl?: undefined
      } & Pick<StorageUploadOptions, 'protected'>)
  )
export {
  Audio,
  Box,
...
declare type SmartImageProps = Omit<ImageProps, 'src'> & {
