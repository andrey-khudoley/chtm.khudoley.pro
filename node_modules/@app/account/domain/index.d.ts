...
import { UgcAccount, UgcDomain, UgcDomainMailingSettings } from 'services/ugc-runner/runtime/runtimeTypes'
...
export declare function getMailingState(_ctx: RichUgcCtx, domain: string): Promise<UgcDomainMailingSettings>
export declare function enableMailing(_ctx: RichUgcCtx, domain: string): Promise<void>
export declare function disableMailing(_ctx: RichUgcCtx, domain: string): Promise<void>
export declare function getDomains(_ctx: RichUgcCtx): Promise<UgcDomain[]>
