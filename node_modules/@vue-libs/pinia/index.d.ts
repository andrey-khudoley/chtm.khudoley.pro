 ...
 */
export declare function acceptHMRUpdate<
 ...
 */
export declare interface DefineSetupStoreOptions<
  Id extends string,
  S extends StateTree,
  G,
  A
 ...
 */
export declare interface DefineStoreOptionsInPlugin<
  Id extends string,
  S extends StateTree,
  G,
  A
 ...
 * For internal use **only**
 */
export declare type _ExtractActionsFromSetupStore<SS> = SS extends
  | undefined
  | void
  ? {}
 ...
 * For internal use **only**
 */
export declare type _ExtractGettersFromSetupStore<SS> = SS extends
  | undefined
  | void
  ? {}
 ...
 * For internal use **only**
 */
export declare type _ExtractStateFromSetupStore<SS> = SS extends
  | undefined
  | void
  ? {}
 ...
 * For internal use **only**
 */
export declare type _GettersTree<S extends StateTree> = Record<
  string,
 ...
 */
declare type _IfEquals<X, Y, A = true, B = false> = (<T>() => T extends X
  ? 1
 ...
 * For internal use **only**
 */
export declare type _MapStateObjectReturn<
  Id extends string,
  S extends StateTree,
  G extends
    | _GettersTree<S>
 ...
 * For internal use **only**
 */
export declare type _MapStateReturn<
  S extends StateTree,
  G extends
    | _GettersTree<S>
    | {
 ...
 */
export declare function mapStores<Stores extends any[]>(
  ...stores: [...Stores]
): _Spread<Stores>;
 ...
 */
export declare function mapWritableState<
  Id extends string,
  S extends StateTree,
  G,
  A,
 ...
 * For internal use **only**
 */
declare type _MapWritableStateKeys<S extends StateTree, G> =
  | keyof UnwrapRef<S>
 ...
 */
export declare interface PiniaPluginContext<
  Id extends string = string,
  S extends StateTree = StateTree,
  G = _GettersTree<S>,
  A = _ActionsTree
 ...
 */
export declare function setMapStoreSuffix(
 ...
 */
export declare interface SetupStoreDefinition<Id extends string, SS>
 ...
 * For internal use **only**.
 */
export declare type _Spread<A extends readonly any[]> = A extends [
  infer L,
  ...infer R
]
 ...
 * Options Store.
 */
export declare type StoreActions<SS> = SS extends Store<
  string,
  StateTree,
 ...
 */
export declare type StoreGeneric = Store<
  string,
  StateTree,
  _GettersTree<StateTree>,
  _ActionsTree
 ...
 * Options Store.
 */
export declare type StoreGetters<SS> = SS extends Store<
  string,
  StateTree,
  infer G,
  _ActionsTree
 ...
 * For internal use **only**.
 */
export declare type _StoreObject<S> = S extends StoreDefinition<
  infer Ids,
  infer State,
  infer Getters,
  infer Actions
 ...
 */
export declare type StoreOnActionListenerContext<
  Id extends string,
  S extends StateTree,
  G,
  A
 ...
 */
export declare type StoreState<SS> = SS extends Store<
  string,
  infer S,
  _GettersTree<StateTree>,
  _ActionsTree
 ...
 */
declare type StoreToRefs<SS extends StoreGeneric> = SS extends unknown
  ? _ToStateRefs<SS> &
 ...
 */
export declare function storeToRefs<SS extends StoreGeneric>(
  store: SS
): StoreToRefs<SS>;
 ...
 * For internal use **only**
 */
export declare type _StoreWithGetters<G> = _StoreWithGetters_Readonly<G> &
 ...
 * newValue`.
 */
export declare interface SubscriptionCallbackMutationDirect
 ...
 * with a function.
 */
export declare interface SubscriptionCallbackMutationPatchFunction
  extends _SubscriptionCallbackMutationBase {
 ...
 * with an object.
 */
export declare interface SubscriptionCallbackMutationPatchObject<S>
  extends _SubscriptionCallbackMutationBase {
 ...
 */
declare type _ToStateRefs<SS> = SS extends Store<
  string,
